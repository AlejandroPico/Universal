...
if (pkg.version !== '1.2.0') throw new Error('La versión de package.json no es 1.2.0.');
if (!html.includes('1.2.0')) throw new Error('La versión visible no coincide.');
if (!readme.includes('1.2.0')) throw new Error('README no documenta la versión actual.');
